...
public class MainActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConvertir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                String fahrenheit_input = piesInput.getText().toString();
                double fahrenheit = Double.parseDouble(fahrenheit_input);
                double fahrenheit_to_celsius = (fahrenheit - 32)  / 1.8;
                String fahrenheit_to_celsius_str = fahrenheit_to_celsius+"";
                resultado_input.setText(fahrenheit_to_celsius_str);
            }
        });
    }
}