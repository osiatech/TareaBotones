...
public class MainActivity4 extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        buttonConvertir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                String metros_input = piesInput.getText().toString();
                double metros = Double.parseDouble(metros_input);
                double metros_to_pies = metros * 3.28084;
                String metros_to_pies_str = metros_to_pies+"";
                resultado_input.setText(metros_to_pies_str);
            }
        });
    }
}